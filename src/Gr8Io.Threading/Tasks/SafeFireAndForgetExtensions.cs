...
/// See: https://github.com/TheCodeTraveler/AsyncAwaitBestPractices
/// </summary>
public static partial class SafeFireAndForgetExtensions
{
    ...
    public static void SafeFireAndForget(this ValueTask task, Action<Exception>? onException,
        bool continueOnCapturedContext = false) => task.SafeFireAndForget(in onException, in continueOnCapturedContext);
    ...
    public static void SafeFireAndForget<T>(this ValueTask<T> task, Action<Exception>? onException,
        bool continueOnCapturedContext = false) => task.SafeFireAndForget(in onException, in continueOnCapturedContext);
    ...
    public static void SafeFireAndForget<TException>(this ValueTask task, Action<TException>? onException,
        bool continueOnCapturedContext = false) where TException : Exception =>
    ...
    /// <typeparam name="T">The return value of the ValueTask.</typeparam>
    /// <typeparam name="TException">Exception type. If an exception is thrown of a different type, it will not be handled</typeparam>
    public static void SafeFireAndForget<T, TException>(this ValueTask<T> task, Action<TException>? onException,
        bool continueOnCapturedContext = false) where TException : Exception =>
        task.SafeFireAndForget(in onException, in continueOnCapturedContext);
    ...
    public static void SafeFireAndForget(this Task task, ConfigureAwaitOptions configureAwaitOptions,
        Action<Exception>? onException = null) => task.SafeFireAndForget(in configureAwaitOptions, in onException);
    ...
    /// <param name="configureAwaitOptions">Options to control behavior when awaiting</param>
    /// <typeparam name="TException">Exception type. If an exception is thrown of a different type, it will not be handled</typeparam>
    public static void SafeFireAndForget<TException>(this Task task, ConfigureAwaitOptions configureAwaitOptions,
...
public static partial class SafeFireAndForgetExtensions
{
    ...
    /// <param name="continueOnCapturedContext">If set to <c>true</c>, continue on captured context; this will ensure that the Synchronization Context returns to the calling thread. If set to <c>false</c>, continue on a different context; this will allow the Synchronization Context to continue on a different thread</param>
    /// <typeparam name="T">The return value of the ValueTask.</typeparam>
    public static void SafeFireAndForget<T>(this ValueTask<T> task, in Action<Exception>? onException = null,
        in bool continueOnCapturedContext = false) =>
        HandleSafeFireAndForget(task, continueOnCapturedContext, onException);
    ...
    /// <typeparam name="T">The return value of the ValueTask.</typeparam>
    /// <typeparam name="TException">Exception type. If an exception is thrown of a different type, it will not be handled</typeparam>
    public static void SafeFireAndForget<T, TException>(this ValueTask<T> task,
        in Action<TException>? onException = null, in bool continueOnCapturedContext = false)
    ...
    /// <param name="onException">If an exception is thrown in the Task, <c>onException</c> will execute. If onException is null, the exception will be re-thrown</param>
    /// <param name="configureAwaitOptions">Options to control behavior when awaiting</param>
    public static void SafeFireAndForget(this Task task, in ConfigureAwaitOptions configureAwaitOptions,
        in Action<Exception>? onException = null) => HandleSafeFireAndForget(task, configureAwaitOptions, onException);
    ...
    /// <param name="configureAwaitOptions">Options to control behavior when awaiting</param>
    /// <typeparam name="TException">Exception type. If an exception is thrown of a different type, it will not be handled</typeparam>
    public static void SafeFireAndForget<TException>(this Task task, in ConfigureAwaitOptions configureAwaitOptions,
        in Action<TException>? onException = null) where TException : Exception =>
    ...
    static async void HandleSafeFireAndForget<TException>(ValueTask valueTask, bool continueOnCapturedContext,
...
#if NET8_0_OR_GREATER
    private static async void HandleSafeFireAndForget<TException>(Task task, ConfigureAwaitOptions configureAwaitOptions,
        Action<TException>? onException) where TException : Exception
    {
        try
        {
