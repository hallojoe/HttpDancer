...
public class UrlNamingTests
{
    ...
    public void GetName_UsesPenultimateSegmentWhenNoFileExtension()
    {
        ...
        var result = UrlNaming.GetName(url, includeQueryString: false);
    ...
    public void GetName_IncludesNormalizedQueryPartsWhenRequested()
    {
        ...
        var result = UrlNaming.GetName(url, includeQueryString: true, baseUrl: "https://www.example.com");
    ...
    public void GetPath_RemovesExcludedSegmentsAndFileName()
    {
        ...
        var result = UrlNaming.GetPath(url, new[] { "-/media", "da" });
    ...
    public void GetPath_NormalizesWithBaseUrlAndSpacing()
    {
        ...
        var result = UrlNaming.GetPath(url, Array.Empty<string>(), baseUrl: "https://example.com/root/");
    ...
    {
        Assert.That(() => UrlNaming.GetName("", false), Throws.ArgumentException);
    }

    [Test]
    public void GetPath_ThrowsOnMissingUrl()
    {
        Assert.That(() => UrlNaming.GetPath("   ", Array.Empty<string>()), Throws.ArgumentException);
    }
}
